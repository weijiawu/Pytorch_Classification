...
logger = setup_logger(os.path.join("/data/glusterfs_cv_04/11121171/AAAI_NL/Baseline_classification/classification_open_image/datasets", 'train_log'))
dataset=open_image_dataset()
dataset.download_train_image()
