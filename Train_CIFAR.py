...
parser.add_argument('--data_path', default="/data/glusterfs_cv_04/11121171/data/CIFAR/cifar100", type=str,
...
parser.add_argument('--Datasets', type=str, default="CIFAR100", help=' ImageNet|Clothing|CIFAR10|CIFAR100')
parser.add_argument('--num_classes', type=str, default=100, help=' classification')
